...
async def run():
    ...
    await drone.param.get_param_int("SYS_AUTOSTART")
    now = datetime.now()
    print("Timecheck PARAM_REQUEST_LIST", now)
    ...
    await drone.mission.clear_mission() # Clear any existing mission on the drone
